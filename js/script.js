 //Model
 var favlocations=[
            {title: 'Gallops', location:{lat: 28.02165548251612,lng: 73.32044621725879}}, 
            {title: 'Lalgarh Palace Museum',location: {lat: 28.008490031703758,lng: 73.3045139439079}}, 
            {title: 'The Laxmi Niwas Palace',location: {lat: 28.040169,lng: 73.331200}}, 
            {title: 'Gajner Palace & Wildlife Sanctuary',location: {lat: 27.945103,lng: 73.052706}}, 
//            {title: 'Karni Mata Temple',location: {lat: 27.790956,lng: 73.340923}}, 
            {title: 'Camel Farm',location: {lat: 27.978908,lng: 73.360870}}, 
            {title: 'Rampuria Haveli',location: {lat: 28.011907,lng: 73.304772}}, 
            {title: 'Jain Temple',location: {lat: 28.010614,lng: 73.303002}}, 
            {title: 'Ganga Singh Museum',location: {lat: 28.022652,lng: 73.317858}}
          ];                                                 
